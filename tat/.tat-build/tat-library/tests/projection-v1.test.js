...
import { tokenize } from "../lexer/tokenize.ts.js";
import { parse } from "../parser/parse.ts.js";
import { executeProgram } from "../runtime/executeProgram.ts.js";
function runTat(source) {
    const tokens = tokenize(source);
    const ast = parse(tokens);
    return executeProgram(ast);
}
function getProjection(result, name) {
