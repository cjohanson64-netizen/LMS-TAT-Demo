...
function evaluateDeriveAggregateSource(
  graph: Graph,
...
function resolveAggregateCollection(
  name: string,
  options?: {
    scope?: GraphControlScope;
    bindings?: RuntimeBindings;
...
function collectAggregateFieldValues(
  graph: Graph,
...
function resolveGraphControlPropertyAccess(
  access: import("../ast/nodeTypes.js").PropertyAccessNode,
  graph: Graph,
  options?: {
    scope?: GraphControlScope;
    bindings?: RuntimeBindings;
